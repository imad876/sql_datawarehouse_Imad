...
Script Purpose:
    - This stored procedure does the ETL process to clean and load data from the bronze tables into the silver tables.
	- Truncates or clears the silver tables before loading
	- Cleans and standardizes the data from bronze into silver.
*/
