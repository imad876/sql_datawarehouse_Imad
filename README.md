...
# Bronze Layer: This is the raw data which is loaded directly from csv files(ERP and CRM sources)

# Silver Layer: In this layer I cleaned and standardized the data to make it ready for analysis

# Gold Layer: Holds the business-ready data modeled into a star schema required for reporting and analytics.
